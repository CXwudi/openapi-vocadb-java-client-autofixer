package mikufan.cx.vocadbapiclient.client;
...
import mikufan.cx.vocadbapiclient.client.auth.Authentication;
...
@Component("mikufan.cx.vocadbapiclient.client.ApiClient")
