package cx.mikufan.vocadbapiclient.client;
...
import cx.mikufan.vocadbapiclient.client.auth.Authentication;
...
@Component("cx.mikufan.vocadbapiclient.client.ApiClient")
